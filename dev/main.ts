...
async function main(): Promise<void> {
  ...
  // const studies = await factory.studies({ StudyInstanceUID: '1.3.6.1.4.1.5962.1.2.5012.1166546115.14677' }); // CT Enchanged
  ...
  const instance = await instances[0].metadata({ includeFields: ['SharedFunctionalGroupsSequence'] });
